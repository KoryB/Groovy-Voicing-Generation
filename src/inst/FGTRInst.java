...
public final class FGTRInst extends Instrument{
	...
	public void createChain(){
		...
		//FilterComponent lpf = new FilterComponent(sin, bandwidthBottom, FilterComponent.LOW_PASS);
		//FilterComponent hpf = new FilterComponent(lpf, bandwidthTop, FilterComponent.HIGH_PASS);
